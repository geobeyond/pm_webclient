	...
	items: [
	        {
            	...
            	items:[
	    			...
	    			},
	    			{
						...
						padding: '5 0 5 0',
	    				handler: function() {
	    				  	url='wmsProxy.php?url='+encodeURIComponent("http://89.31.77.165//geoserver/ows?service=wms&request=GetCapabilities");
	    				  	//url="http://89.31.77.165//geoserver/ows?service=wms&request=GetCapabilities";
	    				  	loadDynWms(url);
	    				 }
	    			},
					{
	    				...
	    				handler: function() {
	    				  	...
	    				  	url='wmsProxy.php?url='+encodeURIComponent(url);
	    				  	loadDynWms(url);
	    				 }
	    			}
    			]
...
function loadDynWms(url){
	console.log('loadDynWms');
	console.log(url);
	var wmsUrl=url;
